...
\begin{equation*}
    ...
    k(i/hT)}\sqrt{T^{-1} \sum_{i=1}^{T} k(i/h'T)}}.
\end{equation*}
...
## This function DFSnoopingCV may long time to compute, the package has results
##f stored for DFSnoopingCV(S=1000, T=1000, grid.length=500) under the data frame
## snoopingcvs
